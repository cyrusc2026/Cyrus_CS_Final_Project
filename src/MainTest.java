...
public class MainTest {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        System.out.println("CHECK: The question length of the Sports file is "+sportsQCount+".");
        ...
        System.out.println("CHECK: Sports file into a 2D array: " + Arrays.deepToString(sportsQBank));
        ...
        while (true) {
            ...
            System.out.println("CHECK: Chosen questions are stored in an array properly: "+ Arrays.deepToString(sportsChosenQuestions));
    ...
    private static void randomisedInput(int qCount, int userInput, String[][] qBank, String[][] qChosen) {
        ...
        System.out.println("CHECK: Randomised numbers: "+ Arrays.toString(questionNumber));
